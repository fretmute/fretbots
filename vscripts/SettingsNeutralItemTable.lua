...
{ 
	...
	{name = 'item_pogo_stick',						tier = 1, ranged = 1, 	melee = 1,		roles={1,1,1,3,3}, realName = "Tumbler's Toy"},	
	{name = 'item_seeds_of_serenity',			tier = 1, ranged = 1, 	melee = 1,		roles={1,1,1,3,3}, realName = "Seeds of Serenity"},	
	{name = 'item_lance_of_pursuit',			tier = 1, ranged = 1, 	melee = 3,		roles={2,2,1,1,1}, realName = "Lance of Pursuit"},	
  ...
  {name = 'item_spy_gadget', 						tier = 4, ranged = 2, 	melee = 0,		roles={0,0,0,3,3}, realName = 'Telescope'},	
	...
	{name = 'item_force_field',						tier = 5, ranged = 1, 	melee = 1,		roles={1,5,1,7,7}, realName = "Arcanist's Armor"},			
}
