...
local sounds =
{
	...
	PERFECT						= 'soundboard.absolutely_perfect',--Broken??plA
	...
	HUI_TIAN					= 'soundboard.hui_tian_mie',			--HUITIANNIIIICEAH
	...
	TIAO_ZOU					= 'soundboard.tiao_zou_le',				--TOZHOULAH!
	...
	WOT_ETO						= 'soundboard.wot_eto_bru',				--Might not be sad, but they sound disappointed
	...
	EnglishCasters =
	{
		...
		'soundboard.absolutely_perfect',									--Broken??
