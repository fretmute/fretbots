...
-- Makes a unit strong
require 'resources/BuffUnit'
-- Settings
require 'resources/Settings'
-- Convenience Utilities
require 'resources/Utilities'
-- Neutral items
require 'resources/NeutralItems'

local role 	= require('resources/RoleUtility')
local radiantTowers	= dofile('resources/RadiantTowers')
local direTowers		= dofile('resources/DireTowers')
