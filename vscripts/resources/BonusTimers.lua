...
local masterNeutralTable = dofile('resources/SettingsNeutralItemTable')
...
function BonusTimers:PerMinuteTimer()
	...
	for _, bot in pairs(Bots) do
		if bot ~= nil then
			...
			if xpBonus > 0 and Settings.deathBonus.enabled['levels'] then
